          ...
          {project.images.length > 0 ? (
            ...
            >
              <img
                ...
                alt={project.title}
                className="w-full h-full object-cover object-[50%_0%] transition-transform duration-1000 group-hover:scale-[1.04]"
                draggable={false}
              />
              <span className="absolute inset-0 flex items-center justify-center bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
