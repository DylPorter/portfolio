...
export const projects: Project[] = [
  ...
  },
  {
    ...
    role: "Solo project",
    highlights: [
      "Agents talk to PACL through four MCP tools — update intent, share context, report activity, query — and coordination comes back piggybacked on the next tool response, so an agent receives it just by continuing to talk.",
      "The central intermediary is itself a Gemini agent: it reads the combined state, decides whether anything needs coordinating, then pushes a natural-language alert or writes a structured ticket.",
